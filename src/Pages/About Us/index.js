...
< Typography variant="h6" sx={{alignItems:'center', justifyContent:'center',display:'flex', color:'orange',mt:10}} textTransform={"none"}>
   Overview
   </Typography>
...
< Typography variant="h6" sx={{textAlign:"center", color:"orange", fontFamily:"Raleway"}}>
Our Mission
   </Typography>
< Typography variant="body1" sx={{textAlign:"center", color:"black", fontFamily:"Raleway",justifyContent:"center",display:"flex"}}>
...
< Typography variant="body1" sx={{textAlign:"center", color:"black", fontFamily:"Raleway"}}>
