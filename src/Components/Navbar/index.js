...
const pages = ['Home', 'About Us', 'Categories','Services','Clients','Contact Us'];
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              ...
              <Button
                ...
                sx={{ my: 3, color: 'white', display: 'block' ,fontFamily:"raleway",fontWeight:500,textTransform:"none" }}
              >
                {page}
              </Button>
              </Link>
